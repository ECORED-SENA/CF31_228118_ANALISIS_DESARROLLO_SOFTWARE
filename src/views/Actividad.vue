  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conceptos clave de virtualización
        p.mb-4 Reconocer  los conceptos fundamentales de la virtualización y las herramientas más utilizadas en la implementación de soluciones virtuales.
